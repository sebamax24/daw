...
<body>
    ...
    <section id="titulooo">
    <h2 class="pdp__title" style="direction:ltr">RED DEAD REDEMPTION 2</h2>
    <div class="provider-info">
        <h5 class="provider-info__text" style="direction:ltr">Rockstar Games.</h5>
    ...
    <section class="slider">
      <div class="w3-content w3-display-container" style="max-width:800px">
          <img class="mySlides w3-animate-right" width="135%" height="400px" src="<?php echo $this->asset; ?>assets/god1.jpg">
          <img class="mySlides w3-animate-right" width="135%" height="400px" src="<?php echo $this->asset; ?>assets/god2.jpg">
          <img class="mySlides w3-animate-right" width="135%" height="400px" src="<?php echo $this->asset; ?>assets/god3.jpg">
          <img class="mySlides w3-animate-right" width="135%" height="400px" src="<?php echo $this->asset; ?>assets/god4.jpg">
    ...
    <div class="large-3">
            ...
            <div>
                <img src="https://store.playstation.com/store/api/chihiro/00_09_000/container/UY/es/19/UP9000-CUSA07408_00-00000000GODOFWAR/1574956922000/image?w=240&h=240&bg_color=000000&opacity=100&_version=00_09_000" >
                  </div>
                ...
                <section id="descrip">
                    <div class="pdp__description">
                        ...
                        <h4>Descrição</h4>
                          ...
                          <p>De la mano del Santa Monica Studio y el director creativo Cory Barlog, llega un nuevo comienzo para uno de los íconos más
                            <p>importantes de la industria de los juegos. Kratos, que vive como un hombre lejos de la sombra de los dioses, deberá adaptarse a tierras 
                            <p>desconocidas, amenazas inesperadas y una segunda oportunidad para oficiar de padre. 
                                <p>Junto a su hijo Atreus se adentrarán en la salvaje tierra nórdica y lucharán para completar una misión profundamente personal.
                        </p>
