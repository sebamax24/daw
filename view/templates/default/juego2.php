...
<body>
    ...
    <section class="slider">
      <div class="w3-content w3-display-container" style="max-width:800px">
          <img class="mySlides w3-animate-right" width="135%" height="400px" src="<?php echo $this->asset; ?>assets/red1.jpg">
          <img class="mySlides w3-animate-right" width="135%" height="400px" src="<?php echo $this->asset; ?>assets/red2.jpg">
          <img class="mySlides w3-animate-right" width="135%" height="400px" src="<?php echo $this->asset; ?>assets/red3.jpg">
          <img class="mySlides w3-animate-right" width="135%" height="400px" src="<?php echo $this->asset; ?>assets/red4.jpg">
    ...
    <div class="large-3">
            ...
            <div>
                <img src="https://store.playstation.com/store/api/chihiro/00_09_000/container/BR/pt/19/UP1004-CUSA03041_00-REDEMPTION000002/1568742338000/image?w=240&h=240&bg_color=000000&opacity=100&_version=00_09_000" >
                  </div>
                ...
                <section id="descrip">
                    <div class="pdp__description">
                        ...
                        <p style="direction:ltr">O jogo mais bem avaliado para PlayStation®4.*
                          <p>
                          ...
                          <p> Os que não se rendem, nem sucumbem, são mortos.
                        <p>Depois de tudo dar errado durante um roubo em uma cidade do oeste chamada Blackwater, Arthur Morgan e a gangue Van der Linde são forçados a fugir.
                          <p> Com agentes federais e os melhores caçadores de recompensas no seu encalço, a gangue precisa roubar, assaltar e lutar para sobreviver no impiedoso coração dos Estados Unidos.
